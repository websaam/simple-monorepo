  ...
  "libs/commands/diff/src/lib/get-last-commit.ts"(exports2, module2) {
    ...
    function getLastCommit(execOpts) {
      if (hasTags2(execOpts)) {
        import_npmlog37.default.silly("getLastTagInBranch");
        return childProcess10.execSync("git", ["describe", "--tags", "--abbrev=0"], execOpts);
      }
      import_npmlog37.default.silly("getFirstCommit");
...
var require_has_commit = __commonJS({
  "libs/commands/diff/src/lib/has-commit.ts"(exports2, module2) {
    ...
    function hasCommit(opts) {
      ...
      let retVal;
      try {
        childProcess10.execSync("git", ["log"], opts);
        retVal = true;
      } catch (e) {
        retVal = false;
      }
      import_npmlog37.default.verbose("hasCommit", retVal);
      return retVal;
    }
  }
});
...
var require_src = __commonJS({
  "libs/commands/diff/src/index.ts"(exports2, module2) {
    ...
    var DiffCommand = class extends Command {
      ...
      execute() {
        return childProcess10.spawn("git", this.args, this.execOpts).catch((err) => {
          if (err.exitCode) {
            throw err;
          }
        });
