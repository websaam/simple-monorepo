...
function resolvePrettier() {
  if (!resolvedPrettier) {
    try {
      ...
      const prettierPath = import_path18.default.join(import_devkit5.workspaceRoot, "node_modules", "prettier");
...
var import_devkit5, import_fs4, import_npmlog38, import_path18, import_slash2, childProcess11, resolvedPrettier;
...
var import_devkit6, import_load_json_file3, import_npmlog45, import_path19;
...
var require_command = __commonJS({
  "libs/commands/version/src/command.ts"(exports2, module2) {
    "use strict";
    var import_npmlog51 = __toESM(require("npmlog"));
    var import_semver8 = __toESM(require("semver"));
    ...
    var command = {
      ...
      builder(yargs2, composed) {
        ...
        return yargs2.option("ignore", {
          ...
          if (argv["--"]) {
            import_npmlog51.default.warn("EDOUBLEDASH", "Arguments after -- are no longer passed to subprocess executions.");
            import_npmlog51.default.warn("EDOUBLEDASH", "This will cause an error in a future major version.");
          }
          return argv;
        });
      },
...
function getCurrentSHA(opts) {
  import_npmlog46.default.silly("getCurrentSHA", "");
  const sha = childProcess18.execSync("git", ["rev-parse", "HEAD"], opts);
  import_npmlog46.default.verbose("getCurrentSHA", sha);
  return sha;
}
...
async function getCurrentTags(execOpts, matchingPattern) {
  import_npmlog47.default.silly("getCurrentTags", "matching %j", matchingPattern);
...
var import_npm_package_arg7, import_npmlog47, childProcess19;
...
async function getProjectsWithTaggedPackages(projectNodes, projectFileMap, execOpts) {
  import_npmlog49.default.silly("getTaggedPackages", "");
...
async function getProjectsWithUnpublishedPackages(projectNodes, opts) {
  import_npmlog50.default.silly("getProjectsWithUnpublishedPackages", "");
  const mapper = (node) => {
    const pkg = getPackage(node);
    ...
    return import_pacote.default.packument(pkg.name, opts).then(
      ...
      () => {
        import_npmlog50.default.warn("", "Unable to determine published version, assuming %j unpublished.", pkg.name);
        return node;
      }
    );
  };
...
var import_npmlog50, import_p_map4, import_pacote;
      ...
      builder(yargs2) {
        ...
        return yargs2.option("npm-tag", {
          ...
          if (argv["npmTag"]) {
            ...
            delete argv["npmTag"];
            delete argv["npm-tag"];
            import_npmlog51.default.warn("deprecated", "--npm-tag has been renamed --dist-tag");
          }
          return argv;
        }).middleware((args) => {
