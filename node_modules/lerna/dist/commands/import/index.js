...
var import_npmlog10, import_os, import_path5, import_write_file_atomic;
...
var import_assert, import_fs3, import_path10, ConfigChain, Conf;
var init_conf = __esm({
  "libs/core/src/lib/npm-conf/conf.ts"() {
    "use strict";
...
var require_src = __commonJS({
  "libs/commands/import/src/index.ts"(exports2, module2) {
    ...
    var ImportCommand = class extends Command {
      ...
      execSync(cmd, args) {
        return childProcess10.execSync(cmd, args, this.execOpts);
      }
      externalExecSync(cmd, args) {
        return childProcess10.execSync(cmd, args, this.externalExecOpts);
      }
...
${version}`;
      ...
      execute() {
        ...
        const mapper = (sha) => {
          ...
          const proc = childProcess10.exec("git", procArgs, this.execOpts);
          ...
          return pulseTillDone(proc).then(() => {
            ...
            if (diff === "") {
              tracker.completeWork(1);
              return childProcess10.exec("git", ["am", "--skip"], this.execOpts);
            }
            err.sha = sha;
            throw err;
          });
