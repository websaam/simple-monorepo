...
function getCycles(dependencies) {
  ...
  function dfs(next, path10) {
    ...
    for (const dep of dependencies[next] || []) {
      if (path10.includes(dep.target)) {
        const cycle = path10.slice(path10.indexOf(dep.target));
        cycles.push(cycle);
      } else if (!visited.has(dep.target)) {
        dfs(dep.target, path10);
      }
    }
    path10.pop();
  }
...
var init_profiler = __esm({
  "libs/core/src/lib/profiler.ts"() {
    ...
    Profiler = class {
      ...
      outputPath;
      threads;
      constructor({ concurrency, log: log35 = import_npmlog30.default, outputDirectory }) {
        this.events = [];
        this.logger = log35;
...
var require_src = __commonJS({
  "libs/commands/run/src/index.ts"(exports2, module2) {
    ...
    var import_run_many = require("nx/src/command-line/run-many");
    var import_run_one = require("nx/src/command-line/run-one");
